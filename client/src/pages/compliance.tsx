      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-12 text-white">
        <section className="bg-blue-950/70 rounded-2xl shadow-lg p-8 border border-green-800 mb-10">
          ...
          <div className="text-blue-200 space-y-4">
            ...
            <p>As a world-class social media platform, we are committed to upholding the highest standards of data protection and privacy, proactively aligning our practices with global best practices and regulatory requirements. We continuously assess our compliance framework to ensure it meets or exceeds the expectations set by leading data protection authorities worldwide, prioritizing transparency, user rights, and robust security measures at every step.</p>
          </div>
        </section>
      </main>
      <Footer />
